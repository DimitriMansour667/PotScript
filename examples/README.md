...
Ready-to-run PotScript programs. Open a Server Pot's terminal, type `edit`,
paste one in and `run` — or carry them between pots on a Memory Card.
...
`help lang` prints the cheatsheet.
